...
public class ImageService {
    ...
    public void textWatermark(String object, String text, int size,OssInterface ossInterface) {
        ...
        //ossService.asyncGetFile(object + queryString);
    }

    //强制缩放，其他缩放方式可以参考图片服务文档
    public void resize(String object, int width, int height,OssInterface ossInterface) {

package com.yunche.android.yunchevideosdk.cview.loadingdialog.views;
...
import com.yunche.android.yunchevideosdk.utils.PixUtils;
...
public class CircleBarView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        barWidth = typedArray.getDimension(R.styleable.CircleBarView_bar_width, PixUtils.dip2px(context,10));
        typedArray.recycle();

        progressNum = 0;
        maxNum = 100;
        defaultSize = PixUtils.dip2px(context,100);
        mRectF = new RectF();
    ...
    public void setFinishProgressColor(String colorStr){
        progressColor = Color.parseColor(colorStr);
        invalidate();
    }
